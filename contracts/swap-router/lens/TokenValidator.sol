...
import "../../periphery/interfaces/IXSwapV2Pair.sol";
import "../interfaces/IXSwapV2Callee.sol";
...
contract TokenValidator is ITokenValidator, IXSwapV2Callee, ImmutableState {
    ...
    function _validate(
        ...
        address pairAddress = XSwapV2Library.pairFor(
            this.factoryV2(),
            token,
            baseToken
        );
        ...
        (, bytes memory returnData) = address(pairAddress).call(
            abi.encodeWithSelector(IXSwapV2Pair.token0.selector)
        );
        ...
        IXSwapV2Pair pair = IXSwapV2Pair(pairAddress);
    ...
    // Override function xswapCall on IXSwapV2Callee
    function xswapCall(
        address,
        uint256 amount0,
        uint256,
        ...
        IXSwapV2Pair pair = IXSwapV2Pair(msg.sender);
