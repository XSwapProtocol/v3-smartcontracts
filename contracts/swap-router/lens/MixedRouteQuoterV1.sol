...
import "../../core/interfaces/callback/IXSwapCallback.sol";
...
import "../../periphery/libraries/PoolTicksCounter.sol";
    ...
    PeripheryImmutableState
{
    ...
    function getPairAmountOut(
        ...
        (uint256 reserveIn, uint256 reserveOut) = XSwapV2Library.getReserves(
            factoryV2,
            tokenIn,
            tokenOut
        );
        return XSwapV2Library.getAmountOut(amountIn, reserveIn, reserveOut);
    }
