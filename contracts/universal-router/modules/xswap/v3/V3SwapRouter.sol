...
import {SafeCast} from "../../../libraries/core/SafeCast.sol";
import {IXSwapPool} from "../../../interfaces/core/IXSwapPool.sol";
import {IXSwapCallback} from "../../../interfaces/core/callback/IXSwapCallback.sol";
...
/// @title Router for XSwap v3 Trades
    ...
    IXSwapCallback
{
    ...
    /// @notice Performs a XSwap v3 exact input swap
    ...
    /// @notice Performs a XSwap v3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = IXSwapPool(
