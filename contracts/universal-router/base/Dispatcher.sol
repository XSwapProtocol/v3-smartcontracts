...
import {V2SwapRouter} from "../modules/xswap/v2/V2SwapRouter.sol";
import {V3SwapRouter} from "../modules/xswap/v3/V3SwapRouter.sol";
import {BytesLib} from "../modules/xswap/v3/BytesLib.sol";
            ...
            if (command < 0x10) {
                ...
                if (command < 0x18) {
                    if (command == Commands.SEAPORT) {
                        ...
                        (success, output) = callAndTransfer1155(
                            inputs,
                            LOOKS_RARE
                        );
