...
contract RouterImmutables {
    ...
    /// @dev The address of XSwapV2Factory
    address internal immutable XSWAP_V2_FACTORY;

    /// @dev The bytes corresponding to XSwapV2Pair initcodehash
    bytes32 internal immutable XSWAP_V2_PAIR_INIT_CODE_HASH;

    /// @dev The address of XSwapV3Factory
    address internal immutable XSWAP_V3_FACTORY;

    /// @dev The bytes corresponding to XSwapV3Pool initcodehash
    bytes32 internal immutable XSWAP_V3_POOL_INIT_CODE_HASH;
    ...
    constructor(RouterParameters memory params) {
        ...
        XSWAP_V2_FACTORY = params.v2Factory;
        XSWAP_V2_PAIR_INIT_CODE_HASH = params.pairInitCodeHash;
        XSWAP_V3_FACTORY = params.v3Factory;
        XSWAP_V3_POOL_INIT_CODE_HASH = params.poolInitCodeHash;
