...
import "./interfaces/IXSwapV2Pair.sol";
    ...
    SelfPermit
{
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IXSwapV2Pair(params.pair).transferFrom(
            msg.sender,
            params.pair,
            params.liquidityToMigrate
        );
        (uint256 amount0V2, uint256 amount1V2) = IXSwapV2Pair(params.pair).burn(
            address(this)
        );
